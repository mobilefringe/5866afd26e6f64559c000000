...
function renderPromotions(container, template, collection){
    ...
    $.each( collection , function( key, val ) {
        ...
        if(val.promo_image_url_abs.indexOf('missing.png') > 0){
            val.promo_image_url_abs  = "//codecloud.cdn.speedyrails.net/sites/5866afd26e6f64559c000000/image/png/1495133900000/tecumseh.png";
        }
    ...
    $(trigger).bind("change", function(e) {
        ...
        $(map).smoothZoom('addLandmark', 
			...
			'<div class="item mark" data-show-at-zoom="0" data-position="' + x_coord + ',' + y_coord + '">\
				...
				<img src="//codecloud.cdn.speedyrails.net/sites/5866afd26e6f64559c000000/image/png/1497039299000/map_marker.png" width="45px" height="59px" alt="marker" />\
				</div>\
			</div>'
			]
		);
